...
gauge = prom.Gauge('moisture_bool', 'Whether moisture has been detected or not', ['instance'])
...
def main(argv):
	...
	callback = lambda channel: debounce_measure(channel, FLAGS.bounce_ms, FLAGS.identifier)
	...
	GPIO.add_event_detect(bcm_channel, GPIO.BOTH, callback=callback, bouncetime=FLAGS.bounce_ms)
